...
namespace Tests\EoneoPay\Webhooks\Stubs\Bridge\Doctrine\Repositories\Webhooks;
...
class RequestRepositoryStub extends RepositoryStub implements WebhookRequestRepositoryInterface
{
     ...
     * @param \EoneoPay\Webhooks\Bridge\Doctrine\Entities\Webhooks\Request[]|null $requests
     */
    ...
    public function getFailedRequestIds(DateTime $since): iterable
    {
         ...
         *
         * @var \EoneoPay\Webhooks\Bridge\Doctrine\Entities\Webhooks\Request $entity
         */
